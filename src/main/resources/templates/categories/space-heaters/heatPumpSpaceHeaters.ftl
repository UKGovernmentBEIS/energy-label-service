...
<@common.standardProductForm title="Heat pump space heaters">
    ...
    <@govukFieldset.fieldset legendHeading="The total rated heat output for medium temperature application, in kW" legendSize="h2" showInInternetLabelling=false>
    ...
    <@govukFieldset.fieldset legendHeading="The total rated heat output for low temperature application, in kW" legendSize="h2" showInInternetLabelling=false>
