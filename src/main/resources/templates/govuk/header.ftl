      ...
      <a href="#" class="govuk-header__link govuk-header__link--homepage">
        <span class="govuk-header__logotype">
          <svg role="presentation" focusable="false" class="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 132 97" height="40px" width="47px">
            ...
            <image src="../govuk-frontend/assets/images/BEIS/beis-logo-white-crest.png" class="govuk-header__logotype-crown-fallback-image"></image>
          </svg>
    ...
    <div class="govuk-header__content">
      ...
      <nav>
        <ul id="navigation" class="govuk-header__navigation " aria-label="Top Level Navigation">
          <#if currentUserView?has_content>
            <#if currentUserView.isAuthenticated()>
              <li class="govuk-header__navigation-item">
                ${currentUserView.getFullName()}
              </li>
              <li class="govuk-header__navigation-item">
                <#-- TODO proper styling -->
                <@form.govukForm springUrl('/logout')>
                  <@govukButton.button buttonText="Sign out" buttonClass="govuk-button--link-exit"/>
                </@form.govukForm>
              </li>
            <#else>
              <li class="govuk-header__navigation-item">
