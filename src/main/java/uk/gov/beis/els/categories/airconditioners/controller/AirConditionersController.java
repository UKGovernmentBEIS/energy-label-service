package uk.gov.beis.els.categories.airconditioners.controller;
...
import uk.gov.beis.els.categories.airconditioners.model.AirConditionersCategory;
...
public class AirConditionersController extends CategoryController {
  ...
  public Object handleCoolingDuctlessAirConditionersSubmit(@Valid @ModelAttribute("form") CoolingDuctlessAirConditionersForm form, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      ...
      return documentRendererService.processResponse(airConditionersService.generateHtml(form, AirConditionersService.LEGISLATION_CATEGORY_CURRENT));
    }
  }
  ...
  public Object handleInternetLabelCoolingDuctlessAirConditionersSubmit(@Validated(InternetLabellingGroup.class) @ModelAttribute("form") CoolingDuctlessAirConditionersForm form, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      ...
      return documentRendererService.processInternetLabelResponse(internetLabelService.generateInternetLabel(form, form.getCoolingEfficiencyRating(), AirConditionersService.LEGISLATION_CATEGORY_CURRENT, ProductMetadata.AC_COOLING_ONLY_NON_DUCT));
    }
  }
  ...
  public Object handleInternetLabelCoolingDuctlessAirConditionersSubmit(@Validated(InternetLabellingGroup.class)@ModelAttribute("form") HeatingDuctlessAirConditionersForm form, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      ...
      return documentRendererService.processInternetLabelResponse(internetLabelService.generateInternetLabel(form, form.getAverageHeatingEfficiencyRating(), AirConditionersService.LEGISLATION_CATEGORY_CURRENT, ProductMetadata.AC_HEATING_ONLY_NON_DUCT));
    }
  }
  ...
  public Object handleInternetLabelReversibleDuctlessAirConditionersSubmit(@Validated(InternetLabellingGroup.class) @ModelAttribute("form") ReversibleDuctlessAirConditionersForm form, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      ...
      return documentRendererService.processInternetLabelResponse(internetLabelService.generateInternetLabel(form, form.getCoolingEfficiencyRating(), AirConditionersService.LEGISLATION_CATEGORY_CURRENT, ProductMetadata.AC_REVERSIBLE_NON_DUCT));
    }
  }
  ...
  public Object handleInternetLabelCoolingDuctedAirConditionersSubmit(@Validated(InternetLabellingGroup.class) @ModelAttribute("form") CoolingDuctedAirConditionersForm form, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      ...
      return documentRendererService.processInternetLabelResponse(internetLabelService.generateInternetLabel(form, form.getCoolingEfficiencyRating(), AirConditionersService.LEGISLATION_CATEGORY_CURRENT, ProductMetadata.AC_COOLING_ONLY_DUCT));
    }
  }
  ...
  public Object handleInternetLabelHeatingDuctedAirConditionersSubmit(@Validated(InternetLabellingGroup.class) @ModelAttribute("form") HeatingDuctedAirConditionersForm form, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      ...
      return documentRendererService.processInternetLabelResponse(internetLabelService.generateInternetLabel(form, form.getHeatingEfficiencyRating(), AirConditionersService.LEGISLATION_CATEGORY_CURRENT, ProductMetadata.AC_HEATING_ONLY_DUCT));
    }
  }
  ...
  public Object handleInternetLabelReversibleDuctedAirConditionersSubmit(@Validated(InternetLabellingGroup.class) @ModelAttribute("form") ReversibleDuctedAirConditionersForm form, BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
      ...
      return documentRendererService.processInternetLabelResponse(internetLabelService.generateInternetLabel(form, form.getCoolingEfficiencyRating(), AirConditionersService.LEGISLATION_CATEGORY_CURRENT, ProductMetadata.AC_REVERSIBLE_DUCT));
    }
  }
  ...
  private void addCommonObjects(ModelAndView modelAndView, List<FieldError> errorList, String submitUrl) {
    RatingClassRange efficiencyRatingRange = AirConditionersService.LEGISLATION_CATEGORY_CURRENT.getPrimaryRatingRange();
