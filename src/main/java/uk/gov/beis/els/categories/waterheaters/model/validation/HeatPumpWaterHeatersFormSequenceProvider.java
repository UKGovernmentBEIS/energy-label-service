...
public class HeatPumpWaterHeatersFormSequenceProvider implements DefaultGroupSequenceProvider<HeatPumpWaterHeatersForm> {

  @Override
  public List<Class<?>> getValidationGroups(HeatPumpWaterHeatersForm form) {
    ...
    sequence.add(HeatPumpWaterHeatersForm.class);
    return sequence;
  }
}
