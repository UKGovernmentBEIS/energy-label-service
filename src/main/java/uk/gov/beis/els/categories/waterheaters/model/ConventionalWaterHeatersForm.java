...
import uk.gov.beis.els.categories.waterheaters.model.validation.ConventionalWaterHeaterFormSequenceProvider;
...
public class ConventionalWaterHeatersForm extends StandardTemplateForm30Char {
  ...
  @NotNull(groups = ConsumptionUnitKw.class)
  @Schema(type = "integer")
  ...
  @NotNull(groups = ConsumptionUnitGj.class)
  @Schema(type = "integer")
  ...
  @NotNull(groups = ConsumptionUnitBoth.class)
  @Schema(type = "integer")
