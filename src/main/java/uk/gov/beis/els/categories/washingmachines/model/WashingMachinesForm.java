...
@StaticProductText("You must attach the label to the front or top of the product so that it’s easy to see. Original-style labels must be at least 110mm x 220mm when printed. New-style 'rescaled' labels must be at least 96mm x 192mm when printed.")
