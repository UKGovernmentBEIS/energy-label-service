...
public class CombinationHeaterPackagesCategory implements Category {

  public static final Category GET = new CombinationHeaterPackagesCategory();

  private static final List<CategoryItem> subCategories = new ImmutableList.Builder<CategoryItem>()
      .add(new CategoryItem(
          "COMBINATION_SPACE_HEATERS_CALCULATOR",
