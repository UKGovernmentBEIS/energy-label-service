...
@Schema(name = "Beverage coolers energy label")
public class BeverageCoolersForm extends StandardTemplateForm40Char {
  ...
  @FieldPrompt("The sum of the gross volumes, expressed in litres, of all compartments functioning at chilled operating temperature")
