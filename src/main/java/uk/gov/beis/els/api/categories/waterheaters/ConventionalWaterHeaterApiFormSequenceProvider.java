...
public class ConventionalWaterHeaterApiFormSequenceProvider implements DefaultGroupSequenceProvider<ConventionalWaterHeaterApiForm> {

  @Override
  public List<Class<?>> getValidationGroups(ConventionalWaterHeaterApiForm form) {
    ...
    sequence.add(ConventionalWaterHeaterApiForm.class);
    return sequence;
  }
}
