...
public class SolarWaterHeatersApiFormSequenceProvider implements DefaultGroupSequenceProvider<SolarWaterHeatersApiForm> {

  @Override
  public List<Class<?>> getValidationGroups(SolarWaterHeatersApiForm form) {
    ...
    sequence.add(SolarWaterHeatersApiForm.class);
    return sequence;
  }
}
