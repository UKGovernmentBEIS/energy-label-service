...
public enum ProductMetadata {
  ...
  TUMBLE_DRYERS_RESCALED("Tumble dryers", "Rescaled tumble dryers", "Tumble dryers"),
  ...
  private final String analyticsProductSubtype;
  private final String productFileName;

  ProductMetadata(String analyticsProductType, String analyticsProductSubtype, String productFileName) {
    this.analyticsProductType = analyticsProductType;
    this.analyticsProductSubtype = analyticsProductSubtype;
    this.productFileName = productFileName;
  }

  ProductMetadata(String analyticsProductType, String productFileName) {
    this.analyticsProductType = analyticsProductType;
    this.analyticsProductSubtype = null;
    this.productFileName = productFileName;
  }

  public String getAnalyticsProductType() {
    return analyticsProductType;
  }

  public String getAnalyticsProductSubtype() {
    return analyticsProductSubtype;
  }
