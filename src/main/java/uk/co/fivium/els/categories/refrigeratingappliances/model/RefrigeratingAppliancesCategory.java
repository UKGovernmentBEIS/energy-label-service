...
public class RefrigeratingAppliancesCategory implements Category {
  ...
  public String getCommonProductGuidanceText() {
    return "Energy labels for domestic fridges, freezers or wine coolers should be at least 110mm x 220mm when printed. The label should then be displayed so that it is easily readable and clearly associated with the product.";
  }
