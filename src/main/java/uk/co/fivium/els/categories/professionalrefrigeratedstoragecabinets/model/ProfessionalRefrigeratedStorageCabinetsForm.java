...
@GroupSequenceProvider(ProfessionalRefrigeratedStorageCabinetsSequenceProvider.class)
public class ProfessionalRefrigeratedStorageCabinetsForm extends StandardTemplateForm30Char {
